          ...
          {result && (
            <>
              ...
              <div className="bg-slate-800 rounded-xl p-4 text-xs text-slate-300 leading-relaxed">
                <strong className="text-amber-400">Clinical Decision Support Only:</strong> This output is generated by ClearPath UM to assist in the review process. All findings must be independently confirmed by a licensed clinical reviewer against the applicable MCG™ or Milliman Care Guidelines® criteria before a determination, denial, or appeal response is issued. ClearPath UM does not issue final coverage determinations.
              </div>
            </>
          )}
        </div>
